...
This repository contains the codebases for the methods described in [**"Safe Gradient Flow for Bilevel Optimization"**](https://arxiv.org/abs/2501.16520), presented at the **2025 American Control Conference (ACC)**, [**"Sequential QCQP for Bilevel Optimization with Line Search"**](https://arxiv.org/abs/2505.14647?) accepted at **IEEE Control Systems Letters (L-CSS)** and **2025 Conference on Decision and Control (CDC)**, and [**"Perturbed gradient descent via convex quadratic approximation for nonconvex bilevel optimization"**](https://arxiv.org/abs/2504.17215) accepter at **Transactions on Machine Learning Research (TMLR)**.
